      ...
      <>
        <div className="d-flex align-items-center justify-content-between bg-light p-3 rounded border border-primary mb-4">
          <div className="d-flex align-items-center gap-3">
            <img src={user} alt="User icon" height={60} width={60} className="rounded-circle border-dark border p-2" />
            <h3 className="mb-0">{profile.userName}</h3>
          </div>
          <small className="text-muted fs-6 mt-3">
            Member since: <span className="fw-bold">{new Date(profile.createdAt).toLocaleDateString()}</span>
          </small>
        </div>
