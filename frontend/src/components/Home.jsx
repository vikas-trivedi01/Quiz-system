    ...
    <>
        ...
        <div className="container row align-items-center">
          ...
          <div className="col-md-6 text-dark">
            <h1 className="display-4 fw-bold mb-3">
              Participate.<br /> Learn.<br /> Grow.
            </h1>
            <p className="lead mb-4">
              Enhance your understanding with engaging quizzes. <br /> Get immediate results and boost your growth.            
            </p>
            <div className="d-flex gap-3">
              <NavLink to="/quizzes/quizlist" className="btn btn-lg text-light" style={{ backgroundColor: "var(--clr-primary)"}}>Explore Quizzes</NavLink>
              <NavLink to="/info/about" className="btn btn-outline-light btn-lg" style={{ backgroundColor: "var(--clr-accent)"}}>About Us</NavLink>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="features-section py-5 text-center bg-light">
        <div className="container">
          ...
          <div className="row">
            {[
              { title: "Wide Range of Topics", desc: "Explore quizzes on various categories to enhance your knowledge." },
              { title: "Instant Feedback", desc: "Get immediate scoring and insights to improve your performance." },
              { title: "User-Friendly Interface", desc: "Enjoy a clean, intuitive platform designed for everyone." }
            ].map((feature, idx) => (
      ...
      <section className="cta bg-dark text-white text-center py-5">
        <div className="container">
          ...
          <p className="fs-5 mb-4">Join thousands of learners already mastering wide range of quizzes with us.</p>
          <NavLink to="/users/signup" className="btn btn-lg px-5" style={{ backgroundColor: "var(--clr-primary)"}}>Get Started</NavLink>
        </div>
      </section>
